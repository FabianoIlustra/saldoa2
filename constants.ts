...
export const DEFAULT_CATEGORIES: Category[] = [
  ...
  { id: '3', name: 'Moradia', color: '#3b82f6' },
  { id: '4', name: 'Transporte', color: '#6366f1' },
  { id: '5', name: 'Lazer', color: '#ec4899' },
  { id: '6', name: 'Educação', color: '#8b5cf6' },
  { id: '7', name: 'Saúde', color: '#ef4444' },
  { id: '8', name: 'Investimentos', color: '#06b6d4' },
  { id: '9', name: 'Outros', color: '#94a3b8' }
];
